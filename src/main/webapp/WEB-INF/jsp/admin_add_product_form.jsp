...
<head>
    ...
    <title>Import Product | HCMUS Product Management</title>
                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Product Information
                                    <small>Modify these informations and press <b>Save</b> to take effect</small>
                                </h2>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                ...
                                <form:form id="demo-form2" commandName="product" class="form-horizontal form-label-left"
                                           method="post" action="/admin_add_product">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <form:input id="product-quantity" class="form-control col-md-7 col-xs-12"
                                                        type="text" name="product_quantity" maxlength="12"
                                                        path="quantity"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
